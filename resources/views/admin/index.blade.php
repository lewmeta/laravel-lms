                ...
                <div class="card radius-10 border-start border-danger border-0 border-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="widgets-icons-2 rounded-circle bg-gradient-burning ms-auto text-white">
                ...
                <div class="card radius-10 border-start border-success border-0 border-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="widgets-icons-2 rounded-circle bg-gradient-ohhappiness ms-auto text-white">
                ...
                <div class="card radius-10 border-start border-warning border-0 border-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="widgets-icons-2 rounded-circle bg-gradient-orange ms-auto text-white">
                        ...
                        <div class="card radius-10 border shadow-none">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="widgets-icons-2 bg-gradient-cosmic ms-auto text-white"><i
